class AppText {
  ...
  static String name = 'الاسم الاول';
  static String familyName = 'اسم العائلة';
  static String mobile = 'رقم الموبايل';
  static String email = 'البريد الالكتروني';
  static String password = 'كلمة المرور';
  static String confirmPassword = 'تأكيد كلمة المرور';
  static String newRegister = 'تسجيل جديد';
  static String login = 'تسجيل الدخول';
  static String doYouHAveAnAccount = ' هل لديك حساب؟';
  static String orRegister = 'أو تسجيل الدخول باستخدام';
